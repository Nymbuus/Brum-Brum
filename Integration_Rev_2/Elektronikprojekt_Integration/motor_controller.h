/********************************************************************************
* motor_controller.h: Contains macro definitions, enumerations and function
*					  definitions and declarations related to control of a DC-
*					  motor using the motor controller MDD3A.
*********************************************************************************/
