...
static double speed_comp_factor = 1;
...
/********************************************************************************
* servo_calculate_speed_comp_factor: Calculates how far from center the servo
*                                    currently is and scales this difference
*                                    to a range between 0.5 and 1.
********************************************************************************/
void servo_calculate_speed_comp_factor(void)
{
	uint8_t error = 0;
	...
	{
		error = current_angle - 90;
	}
	
	speed_comp_factor = 1.0 - (error * 0.0056);
...
/********************************************************************************
* servo_get_speed_comp_factor: Returns the variable speed_comp_factor.
********************************************************************************/
double servo_get_speed_comp_factor(void)
{
	return speed_comp_factor;
}